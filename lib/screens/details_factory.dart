...
class DetailsFactory extends StatefulWidget {
  var product;
  String title;
  String storeName;
  String des;
  ...
  @override
  _DetailsFactoryState createState() => _DetailsFactoryState();
}

class _DetailsFactoryState extends State<DetailsFactory> {
  int _index = 0;
